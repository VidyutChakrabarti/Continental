...
public class Bill_Payment_Deal_Four extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(c.moveToFirst()){
            ...
            Toast.makeText(Bill_Payment_Deal_Four.this, "Previous orders not retrievable. ", Toast.LENGTH_LONG).show();
        }
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(username)) {
                    ...
                    if (userPhoneNumber != null) {
                        ...
                        Toast.makeText(Bill_Payment_Deal_Four.this, "Error: Phone number not found.", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void showNotification(String title, String message) {
        Intent intent = new Intent(Bill_Payment_Deal_Four.this, Order_Summary.class);
        intent.putExtra("username", username);
        intent.putExtra("address", address);
        intent.putExtra("phone", phone);
        intent.putExtra("bill", "Amount: 400 INR");
        intent.putExtra("order", "Deal Five");
        PendingIntent pendingIntent = PendingIntent.getActivity(Bill_Payment_Deal_Four.this, 0, intent,
