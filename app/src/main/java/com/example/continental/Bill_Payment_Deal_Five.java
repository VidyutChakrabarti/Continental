...
public class Bill_Payment_Deal_Five extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bill_payment_deal_five);
        ...
        if (c.moveToFirst()) {
            ...
            Toast.makeText(Bill_Payment_Deal_Five.this, "Previous orders not retrievable. ", Toast.LENGTH_LONG).show();
        }
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(username)) {
                    ...
                    if (userPhoneNumber != null) {
                        ...
                        Toast.makeText(Bill_Payment_Deal_Five.this, "Error: Phone number not found.", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void sendNotification(String phoneNumber, String message, String username) {
        ...
        Toast.makeText(Bill_Payment_Deal_Five.this, "Your order is confirmed "+username, Toast.LENGTH_LONG).show();
        createNotificationChannel();
        showNotification("Order Confirmed", "Your order is confirmed " + username);
    }

    private void showNotification(String title, String message) {
        Intent intent = new Intent(Bill_Payment_Deal_Five.this, Order_Summary.class);
        intent.putExtra("username", username);
        intent.putExtra("address", address);
        intent.putExtra("phone", phone);
        intent.putExtra("bill", "Amount: 400 INR");
        intent.putExtra("order", "Deal Five");
        PendingIntent pendingIntent = PendingIntent.getActivity(Bill_Payment_Deal_Five.this, 0, intent,
